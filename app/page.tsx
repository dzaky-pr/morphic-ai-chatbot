    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <header className="flex flex-col items-center justify-center bg-gradient-to-r bg-background h-[70vh] text-center py-12">
        ...
        <p className="text-xl mb-6 max-w-3xl">
          Standar Konstruksi by Artificial Intelligence (NUII) Solusi AI cerdas
          untuk perencanaan dan pengawasan konstruksi jaringan listrik PLN,
          dengan data standar, material, gambar, dan RAB dalam genggaman.
        </p>
